...
Пример работы:  5_1/4\*6+3\*i+1:i-63-3/70:5/6+4_1/23+10\*i\*2:3\*i+10_1/2\*i\*2\*i
 => a+b\*i
...
- Считывание идет сразу полным выражением  
    ...
    3. Мнимая часть помечается мнимой единицей i , в положительной степени записывается *i, в минус первой 1:i . *i <=> \*1\*i
